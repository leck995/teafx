...
import cn.tealc.teafx.stage.handler.ResizeWindowHandler;
...
public class RoundStage extends TeaStage {
    private final ResizeWindowHandler resizeWindowHandler;
    ...
    public RoundStage() {
        ...
        resizeWindowHandler = new ResizeWindowHandler(this);
    ...
    public void setMinSize(double width, double height){
        resizeWindowHandler.setMinSize(width, height);
    }
