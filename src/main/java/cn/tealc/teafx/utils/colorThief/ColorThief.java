...
/*
 * ColorThief代码来自https://github.com/SvenWoltmann/color-thief-java/tree/master。
 * */
public class ColorThief {
    ...
    public static int[][] getPalette(BufferedImage sourceImage, int colorCount) {
        ColorMap cmap = getColorMap(sourceImage, colorCount);
        if (cmap == null) {
            return null;
        }
        return cmap.palette();
    ...
    public static int[][] getPalette(
            ...
            int quality,
            boolean ignoreWhite) {
        ColorMap cmap = getColorMap(sourceImage, colorCount, quality, ignoreWhite);
        if (cmap == null) {
            return null;
        }
        return cmap.palette();
    ...
    public static ColorMap getColorMap(
        ...
        ColorMap cmap = MMCQ.quantize(pixelArray, colorCount);
        return cmap;
    }
